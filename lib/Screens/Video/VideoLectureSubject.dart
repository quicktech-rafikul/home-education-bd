...
class QuickTechIT_VideoLectureSubject extends StatefulWidget {
  @override
  _QuickTechIT_VideoLectureSubjectState createState() => _QuickTechIT_VideoLectureSubjectState();
}

class _QuickTechIT_VideoLectureSubjectState extends State<QuickTechIT_VideoLectureSubject> {
        ...
        child: Column(
          children: [
            Container(
              ...
              child: TextButton(
                  onPressed: () {
                    Get.toNamed('/videoLectureList/free');
                  },
                  style: ButtonStyle(
                            ...
                            onPressed: () async {
                              if (subjects[index].isPremium) {
                                if (await Database()
                                  ...
                                  Get.toNamed('/videoLectureTopic/${subjects[index].id}');
                                } else {
                                  Get.defaultDialog(
