...
class QuickTechIT_MCQTopicList extends StatefulWidget {
  @override
  _QuickTechIT_MCQTopicListState createState() => _QuickTechIT_MCQTopicListState();
}

class _QuickTechIT_MCQTopicListState extends State<QuickTechIT_MCQTopicList> {
              ...
              return Column(
                children: [
                  Container(
                    ...
                    child: TextButton(
                        onPressed: () {
                          Get.toNamed('/mcq/list/${topics[index].id}');
                        },
                        style: ButtonStyle(
