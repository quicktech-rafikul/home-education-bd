...
class QuickTechIT_MCQSubjectList extends StatefulWidget {
  @override
  _QuickTechIT_MCQSubjectListState createState() => _QuickTechIT_MCQSubjectListState();
}

class _QuickTechIT_MCQSubjectListState extends State<QuickTechIT_MCQSubjectList> {
                        ...
                        onPressed: () async {
                          if (subjects[index].isPremium) {
                            if (await Database()
                              ...
                              Get.toNamed('/mcq/topic/${subjects[index].id}');
                            } else {
                              Get.defaultDialog(
