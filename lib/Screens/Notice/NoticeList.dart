...
class QuickTechIT_NoticeList extends StatefulWidget {
  @override
  _QuickTechIT_NoticeListState createState() => _QuickTechIT_NoticeListState();
}

class _QuickTechIT_NoticeListState extends State<QuickTechIT_NoticeList> {
  ...
  @override
  void initState() {
    Database().getNotices().then((value) {
      setState(() {
        notices = value;
      });
    });
              ...
              return Column(
                children: [
                  Card(
                      child: InkWell(
                    onTap: () {
                      Get.toNamed('/notice/view/${notices[index].id}');
                    },
                    child: Container(
