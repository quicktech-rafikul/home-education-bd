...
class QuickTechIT_LectureNoticeTopicList extends StatefulWidget {
  @override
  _QuickTechIT_LectureNoticeTopicListState createState() => _QuickTechIT_LectureNoticeTopicListState();
}

class _QuickTechIT_LectureNoticeTopicListState extends State<QuickTechIT_LectureNoticeTopicList> {
              ...
              return Column(
                children: [
                  Container(
                    ...
                    child: TextButton(
                        onPressed: () {
                          Get.toNamed('/notice/list/${topics[index].id}');
                        },
                        style: ButtonStyle(
